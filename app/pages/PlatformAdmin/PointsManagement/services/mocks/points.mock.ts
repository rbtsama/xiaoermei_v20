...
export const mockOperationLogs: OperationLog[] = [
  {
    ...
    operationDetails: '修改注册奖励从50积分改为100积分',
    operator: '兔子',
    operatedAt: '2025/01/22 10:30:15',
  },
  {
    id: 'op_log_002',
    operationType: '编辑基础规则',
    operationDetails: '修改积分兑换汇率从50积分=1元改为100积分=1元',
    operator: '兔子',
    operatedAt: '2025/01/20 14:20:30',
  },
  {
    id: 'op_log_003',
    operationType: '新增积分奖励规则',
    operationDetails: '新增规则：推荐商家，奖励50积分',
    targetId: 'pr008',
    operator: '兔子',
  ...
  },
  {
    ...
    operationDetails: '为用户13800138000调整增加100积分，原因：系统异常补偿',
    targetId: 'user_001',
    operator: '兔子',
  ...
  {
    id: 'op_log_005',
    operationType: '停用积分规则',
    operationDetails: '停用规则：分享朋友圈',
    targetId: 'pr009',
    operator: '兔子',
  ...
  {
    id: 'op_log_006',
    operationType: '删除积分规则',
    operationDetails: '删除规则：温泉体验券',
    targetId: 'pe009',
    operator: '兔子',
