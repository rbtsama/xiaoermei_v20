  ...
  modules: [
    {
      ...
      functions: [
        ...
        '协议模板管理（创建/编辑/版本控制）',
        '签约记录查询（查看/筛选/导出）',
        '酒店开通流程（生成账号/追踪进度/通知上线）',
      ],
    },
    {
      name: '会员管理',
      functions: [
        '会员等级配置（等级信息/升级条件/权益折扣）',
        '会员列表管理（查看/筛选/详情/导出）',
    ...
    },
    {
      name: '积分优惠券',
      functions: [
        '里程值规则配置（获得规则/兑换规则/有效期）',
        '用户里程值账户（查看余额/流水明细/手动调整）',
...
const hotelArchitecture = {
  ...
  modules: [
    ...
    },
    {
      ...
      functions: [
        '门店列表（查看/切换/状态管理）',
        '基本信息配置（名称地址/媒体资源/标签介绍）',
        '门店图片管理（相册/分享图/排序）',
        '门店设施配置（分类选择/全选/搜索）',
        '门店政策配置（时间/取消/儿童/折扣/备选要求）',
        '早餐配置（类型/价格/时间）',
        '加床配置（费用/数量限制/婴儿床）',
        '周边信息配置（景点/交通/逛吃/交通图）',
        '门店礼赠管理（添加/编辑/排序/启用）',
...
const miniprogramArchitecture = {
  ...
  modules: [
    ...
    },
    {
      ...
      functions: [
        '会员礼遇（明信片/自定义赠言/分享）',
        '会员中心（等级卡/权益/升级进度/快捷开通）',
        '开通会员（VIP2年卡/权益说明/FAQ/购买）',
        '会员邀请（定向/无限制/确认/记录）',
        '里程值券包（余额/流水/规则/优惠券使用）',
      ],
    },
    {
      name: '收藏历史',
