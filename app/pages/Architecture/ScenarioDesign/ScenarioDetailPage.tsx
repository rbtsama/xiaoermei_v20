...
export default function ScenarioDetailPage({ scenario, isLearningMode = true }: ScenarioDetailPageProps) {
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <LearningModal title={`${scenario.title} - 学习内容`} isLearningMode={isLearningMode}>
            <div className="space-y-4">
              <section>
                <h3 className="text-lg font-semibold mb-2">场景说明</h3>
                <p className="text-slate-600">{scenario.description}</p>
              </section>

              <section>
                <h3 className="text-lg font-semibold mb-2">流程图说明</h3>
                <p className="text-slate-600 mb-3">
                  本流程图展示了从起点到终点的完整业务流程，每个步骤都标注了所属系统。
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-primary/20 border-2 border-primary rounded" />
                    <span className="text-sm text-slate-600">平台后台 - 负责规则制定和数据处理</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-secondary/20 border-2 border-secondary rounded" />
                    <span className="text-sm text-slate-600">商户端 - 负责配置执行和订单管理</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-accent/15 border-2 border-accent rounded" />
                    <span className="text-sm text-slate-600">C端 - 用户交互界面</span>
                  </div>
                </div>
              </section>

              <section>
                <h3 className="text-lg font-semibold mb-2">关键要点</h3>
              ...
              <section>
                <h3 className="text-lg font-semibold mb-2">实施建议</h3>
