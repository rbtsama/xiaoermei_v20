...
export const mockScenarios: Scenario[] = [
  ...
  },
  {
    ...
    title: '流程5：下单 → 积分抵扣/服务 → 支付',
    description: '用户下单时可选择积分服务和积分抵扣，系统实时校验积分余额',
    flowSteps: [
      {
        id: 'step-5-1',
        title: 'C端用户选择房型',
      ...
      },
      {
        id: 'step-5-2',
        title: '平台后台读取配置',
        description: '获取用户积分和商户服务',
        system: '平台后台',
        details: [
          '读取用户剩余积分：80积分',
          '读取商户积分服务配置',
          '读取用户会员等级积分汇率：1.2倍（VIP3）',
        ],
      },
      {
        id: 'step-5-3',
        title: 'C端订单确认页展示',
        description: '显示积分服务选项',
        system: 'C端',
        details: [
          '房费：¥396（VIP3平日特惠价）',
          '环保奖励（离店后返还）：',
  ...
  },
  {
    ...
    title: '流程6：离店 → 积分奖励 → 邀请奖励',
    description: '用户离店后，系统自动计算间夜数、发放积分奖励、检查升级和邀请奖励',
    flowSteps: [
      {
        id: 'step-6-1',
        title: '商户端用户退房',
  ...
  },
  {
    ...
    title: '流程7：代客下单 → 扫码支付（不支持积分）',
    description: '商户为老客户创建专属订单，生成付款二维码，客户扫码支付',
    flowSteps: [
      {
        id: 'step-7-1',
        title: '商户端选择代客下单',
