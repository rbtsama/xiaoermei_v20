  ...
  >
    ...
    <div class="guide-content">
      ...
      <div class="materials-section">
        ...
        <div class="material-card">
          <div class="card-header">
            <a-icon type="file-protect" class="header-icon policy-icon" />
            <span class="card-title">运营政策</span>
          </div>
          <div class="card-content">
            <div class="material-list">
              <div class="material-item">
                <span class="item-number">1</span>
                <div class="item-content">
                  <span class="item-title">入住时间、退房时间、最晚预订时间</span>
                  <a-button type="link" size="small" @click="handlePreviewInfo('check-in-policy')" class="example-btn">
              ...
              <div class="material-item">
                <span class="item-number">2</span>
                <div class="item-content">
                  <span class="item-title">取消政策、儿童政策、宠物政策</span>
                  <a-button type="link" size="small" @click="handlePreviewInfo('policies')" class="example-btn">
                    <a-icon type="info-circle" />查看示例
                  </a-button>
                </div>
              </div>
              <div class="material-item">
                <span class="item-number">3</span>
                <div class="item-content">
                  <span class="item-title">加床规则、早餐说明、门店须知</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="material-card">
          <div class="card-header">
            <a-icon type="home" class="header-icon room-icon" />
            <span class="card-title">房型资料</span>
          </div>
          <div class="card-content">
            <div class="material-list">
              <div class="material-item">
                <span class="item-number">1</span>
                <div class="item-content">
                  <span class="item-title">房型名称、面积、床型、楼层、可住人数</span>
                  <a-button type="link" size="small" @click="handlePreviewInfo('room-basic')" class="example-btn">
                    <a-icon type="info-circle" />查看示例
                  </a-button>
                </div>
              </div>
              <div class="material-item">
                <span class="item-number">2</span>
                <div class="item-content">
                  <span class="item-title">房型设施清单（卫浴、家电、洗漱用品等）</span>
                  <a-button type="link" size="small" @click="handlePreviewInfo('room-facilities')" class="example-btn">
              ...
              <div class="material-item">
                <span class="item-number">3</span>
                <div class="item-content">
                  <span class="item-title">房型图片（3-5张展示图）</span>
                </div>
              </div>
            </div>
          </div>
